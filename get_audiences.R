...
uswtm <- vroom::vroom("data/722fe36a-3d43-4446-9811-2ea802be7c33.csv.gzip") %>% 
...
thedate <- as.Date(us_markers$ds[1]) - 1

# da7 %>%  filter(page_id == "153080620724")
da30 <- metatargetr::get_targeting_db(thecntry, 30, thedate) 
da7 <- metatargetr::get_targeting_db(thecntry, 7, thedate) 
