...
interest_targeting30 <-  election_dat30 %>%
  ...
  mutate(detailed_type = case_when(
    ...
    detailed_type == "BEHAVIORS" ~ "BEHAVIORS",
    T ~ detailed_type
  ))
...
target == "lookalike_audience" ~ "CUSTOM AUDIENCES",
target == "interest" ~ "INTERESTS",
target == "age" ~ "DEMOGRAPHY",
target == "zips" ~ "GEOGRAPHY",
target == "CITY" ~ "GEOGRAPHY",
target == "language" ~ "DEMOGRAPHY",
target == "gender" ~ "DEMOGRAPHY",
target == "Gender: Mannen" ~ "DEMOGRAPHY",
target == "Gender: Vrouwen" ~ "DEMOGRAPHY",
target == "COMUNE" ~ "GEOGRAPHY",
target == "electoral_districts" ~ "GEOGRAPHY",
target == "COUNTY" ~ "GEOGRAPHY",
str_detect(target, "NEIGHBOR") ~ "GEOGRAPHY",
  ...
  reactable(
    ...
    columns = list(
      Pagina = colDef(
        name = "Page",
        cell = function(value) {
          internal_id <- yes$internal_id[yes$Pagina == value]
      ...
      htmltools::div(
        ...
        reactable(
          ...
          columns = list(
            ...
            is_exclusion = colDef(header = "Inclusief", width = 100),
